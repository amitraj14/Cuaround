                     ...
                     for (nearplace in json.results)
                      {
                        ...
                        anchorPoint: new google.maps.Point(0, -29)
                         ...
                         ////forsidebar& distance
                        // (function(){
                        //   var dist="https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins="+place.geometry.location.lat()+","+place.geometry.location.lng()+"&destinations="+data.geometry.location.lat+","+data.geometry.location.lng+"&key=AIzaSyDML2NAuWndTUnYF9hj4GB-jVRbIfwX_O0";

                        // $.getJSON(dist,function(json3){

                        //   console.log(json3.rows[0].elements[0].distance.text);
                     ...
                     for (nearplace in json.results)
                      {
                        ...
                        ////forsidebar& distance
                        // (function(){
                        //   var dist="https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins="+location.coords.latitude+","+location.coords.longitude+"&destinations="+data.geometry.location.lat+","+data.geometry.location.lng+"&key=AIzaSyDML2NAuWndTUnYF9hj4GB-jVRbIfwX_O0";
